...
func Test1AccordingToLife(t *testing.T) {
	...
	couleur_init := particule.UpdateAccordingToLife(minCouleur, maxCouleur, MaxLife)

	particule.Life = 10
	couleur_fin := particule.UpdateAccordingToLife(minCouleur, maxCouleur, MaxLife)
...
func Test2AccordingToLife(t *testing.T) {
	...
	particule = Basique_Particule()
	particule.Life = 25
	couleur := particule.UpdateAccordingToLife(minCouleur, maxCouleur, MaxLife)
