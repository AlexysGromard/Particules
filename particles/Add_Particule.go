...
// cette fonction crée des particules en fonction des paramètres indiqués dans "config.json"
// si DeadListe contient des particules alors il réutilise les particules contenues dans DeadList
...
func (s *System) Add_Particule() {
	...
	//Ajoute de la particule au System
